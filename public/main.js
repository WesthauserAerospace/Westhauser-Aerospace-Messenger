...
// LEAFLET MAP
// ========================================
let OLLAMA_URL = 'http://localhost:11434';  // Dynamic for Cloudflare support
let map = null;
...
function sendImageToTX() {
    ...
    chat.innerHTML += `<div class="message system"><strong>[📸 BILDANALYSE-ZENTRUM]</strong><br>${window.lastImageAnalysis.result}</div>`;
    chat.scrollTop = chat.scrollHeight;
...
function sendEnvToTX() {
    ...
    // System Message in TX Chat
    chat.innerHTML += `<div class="message system"><strong>[📹 UMGEBUNGS-KAMERA]</strong><br>${window.lastEnvAnalysis.result}</div>`;
    chat.scrollTop = chat.scrollHeight;
...
function sendDocToTX() {
    ...
    // System Message in TX Chat
    chat.innerHTML += `<div class="message system"><strong>[📄 DOKUMENT-ANALYSE]</strong><br>Dokument: ${window.lastDocAnalysis.document}<br>Frage: ${window.lastDocAnalysis.query}<br>Antwort: ${window.lastDocAnalysis.result}</div>`;
    chat.scrollTop = chat.scrollHeight;
...
function activateCloudflare() {
    ...
    // SET OLLAMA_URL FOR VISION MODULES! ✅
    OLLAMA_URL = url;
    console.log('✅ Vision Modules nutzen jetzt:', OLLAMA_URL);
    ...
    alert(`✅ Cloudflare aktiviert!\n\nVision Module nutzen jetzt:\n${url}`);
